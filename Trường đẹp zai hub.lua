...
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = "Trường đẹp zai hub"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
...
if  game.Players.LocalPlayer.Name == "JayceGuys019" or  game.Players.LocalPlayer.Name == "Truongdepzai34" then
DiscordLib:Notification("Thông Báo" , "Chào Bạn, Mình Là Admin Bản Trường đẹp zai hub" , 6 ,11816162894)
    DiscordLib:Notification("Thông Báo" , "Cảm Ơn Bạn Đã Sử Dụng Trường đẹp zai hub" , 8,11816162894)
